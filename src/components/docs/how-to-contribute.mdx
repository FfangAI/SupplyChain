...
1. Contribution Requirements :
    * When you contribute, you agree to give a non-exclusive license to AI4AI.io to use that contribution in any context as we see appropriate.
...
2. Installation :
    ...
    * Clone to your machine
    ...
    ```bash
    git clone https://github.com/YOUR_USERNAME/AI4AI.git
    ```
